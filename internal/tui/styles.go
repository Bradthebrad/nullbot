...
var themes = []themePalette{
	{ID: "steel", Name: "Classic NullBot", Description: "The screenshot-accurate house style: black glass, teal output frame, gold activity frame, mint status bars, and molten arcade title.", Background: "#050707", Panel: "#10191C", Activity: "#171D21", Modal: "#142226", Border: "#2E8B86", ActivityBor: "#D8B13E", Accent: "#FFD300", Accent2: "#9DD9D2", BannerTop: "#FFF06A", Text: "#E8F1F2", Muted: "#93A5AA", StatusBG: "#9DD9D2", StatusFG: "#102A2A", InputBorder: "#8FB8AE", CodeBG: "#1D2A2D", CodeFG: "#D9E6A3"},
